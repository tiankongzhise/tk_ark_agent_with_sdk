...
import json
from src.tk_ark_agent_with_sdk.database.curd import Curd
from src.tk_ark_agent_with_sdk.database.models import IpInfoTable
from src.tk_ark_agent_with_sdk.utils import fomart_agent_rsp
load_dotenv()
def test():
  ...
  al_model = 'DEEPSEEK-V3'
  model_id = "ep-20250427171507-l9cgg"
  ...
  fomated_rsp = fomart_agent_rsp(rsp_json,al_model)
  db_client = Curd()
  for i in fomated_rsp:
      db_client.add_or_update_table(IpInfoTable,i)
